...
public interface JItemRegistry {
    ...
    CosplayItem<FlutteringArmorItem> DIO_CAPE = new CosplayItem<>(JCraft.MOD_ID, "dio_cape", ArmorItem.Type.CHESTPLATE, FlutteringArmorItem::new).register(JItemRegistry::register);
