...
public class Hamon6Trigger extends SimpleCriterionTrigger<Hamon6Trigger.TriggerInstance> {

    public final static ResourceLocation ID = JCraft.id("hamon6");
    ...
    public void trigger(final ServerPlayer player) {
        this.trigger(player, ti -> JUtils.hasAdvancement(player, Hamon5Trigger.ID));
    }

    public static class TriggerInstance extends AbstractCriterionTriggerInstance {

        public TriggerInstance(final ContextAwarePredicate player) {
            super(Hamon6Trigger.ID, player);
        }
